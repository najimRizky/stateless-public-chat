...
const Home: NextPage = () => {
    ...
    // Receive messages from server (realtime)
    useEffect(() => {
    ...
    const scrollDownMessages = () => {
        document.getElementsByClassName("messagesBox")[0].scrollTo(0, document.getElementsByClassName("messagesBox")[0].scrollHeight)
    }
    ...
    return (
        <>
            ...
            {ModalGetUsername(connectUser)}
        </>
    )
}

const ModalGetUsername = (connectUser: (usernameTmp: string) => void) => {
